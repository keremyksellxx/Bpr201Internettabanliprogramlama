...
<head>
  ...
  <title>Haberleri Yönet - Admin</title>
...
<body>
  ...
  <div class="content">
    <h2 class="text-success mb-4">Haberleri Yönet</h2>
    <button class="btn btn-primary mb-3"><i class="bi bi-plus-circle me-1"></i> Yeni Haber Ekle</button>
