...
if (isset($_POST['add_haber'])) {
    ...
    // Admin tarafından eklendi bilgisi burada yazılıyor
            ...
            <tbody>
                ...
                <tr>
                    <form method="POST">
                        ...
                        <td><input type="text" name="kategori" class="form-control" value="<?= htmlspecialchars($h['kategori']) ?>"></td>
                        <td><input type="text" name="resim" class="form-control" value="<?= htmlspecialchars($h['resim']) ?>"></td>
                        <td>
                            <button type="submit" name="update_haber" class="btn btn-primary btn-sm mb-1 w-100">Güncelle</button>
                            <a href="?delete_id=<?= $h['id'] ?>" class="btn btn-danger btn-sm w-100" onclick="return confirm('Bu haber silinsin mi?')">Sil</a>
                        </td>
                    </form>
                </tr>
                <?php $s++; endforeach; ?>
