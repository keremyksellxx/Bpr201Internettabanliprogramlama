...
.navbar-toggler {
    border-color: rgba(255,255,255,0.6) !important;  /* çerçeve beyaz */
}

.navbar-toggler-icon {
    filter: brightness(0) invert(1) !important; /* ikon beyaz olur */
}
...
<<nav class="navbar navbar-expand-lg fixed-top">
  <div class="container">
    ...
    <li class="nav-item">
      <a class="nav-link text-warning fw-bold" href="profil.php">
