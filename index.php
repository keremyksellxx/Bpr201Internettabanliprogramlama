...
<head>
  ...
  <title>YeniHaber - Gündemi Bizimle Takip Et</title>
  ...
  <style>
    ...
    .hero::before {
      ...
      background: linear-gradient(to bottom right, rgba(10,25,47,0.8), rgba(17,34,64,0.85));
    }
    .hero h1, .hero p {
      position: relative;
      z-index: 1;
...
<div class="container mt-5 pt-4">
  <div class="row g-4">
    <?php
    $haberler = [
      ["Siyaset", "Siyasette Yeni Dönem Başladı", "https://source.unsplash.com/600x400/?politics", "Ülkede son seçimlerin ardından yeni düzenlemeler gündemde..."],
      ["Teknoloji", "Yapay Zeka Dünyayı Değiştiriyor", "https://source.unsplash.com/600x400/?technology", "Yapay zekanın sağlık, eğitim ve sanayi üzerindeki etkileri hızla büyüyor..."],
      ["Ekonomi", "Ekonomide Dalgalı Seyir", "https://source.unsplash.com/600x400/?economy", "Piyasalar son gelişmelere göre karışık bir tablo sergiliyor..."]
    ];
